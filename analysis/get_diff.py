...
def get_difference(
    ...
    for idx in range(len(model_one_results)):
        ...
        if model_one_results[idx]["acc"] == model_two_results[idx]["acc"]:
            continue
    ...
    sys.stdout.write(
        f"{'Concept Name':15} | {'Model One Correct':20} | {'Model Two Correct':20} | {'Total Instances':20} | {'Percentage of Total':25}\n"
    )
    sys.stdout.write(f"{'-'*120}\n")

    for concept in concepts:
        percentage = round(
            ((concepts[concept][0] + concepts[concept][1]) / concepts[concept][2]),
            ndigits=2,
        )
        sys.stdout.write(
            f"{concept:15} | {concepts[concept][0]:20} | {concepts[concept][1]:20} | {concepts[concept][2]:20} | {percentage:25}\n"
        )
    sys.stdout.write("\n")
    sys.stdout.write(f"{'='*120}\n\n")
    ...
    sys.stdout.write(
        f"{'Context Name':15} | {'Model One Correct':20} | {'Model Two Correct':20} | {'Total Instances':20} | {'Percentage of Total':25}\n"
    )
    sys.stdout.write(f"{'-'*120}\n")
    ...
    for context in contextTypes:
        ...
        sys.stdout.write(
            f"{context:15} | {contextTypes[context][0]:20} | {contextTypes[context][1]:20} | {contextTypes[context][2]:20} | {percentage:25}\n"
        )
    sys.stdout.write("\n")
    sys.stdout.write(f"{'='*120}\n\n")
    ...
    for context in contextDiffs:
        ...
        sys.stdout.write(
            f"{context:15} | {contextDiffs[context][0]:20} | {contextDiffs[context][1]:20} | {contextDiffs[context][2]:20} | {percentage:25}\n"
        )
    sys.stdout.write("\n")
    sys.stdout.write(f"{'='*120}\n\n")
    ...
    sys.stdout.write(
        f"{'Target Name':15} | {'Model One Correct':20} | {'Model Two Correct':20} | {'Total Instances':20} | {'Percentage of Total':25}\n"
    )
    sys.stdout.write(f"{'-'*120}\n")
    for target in targetDiffs:
        ...
        sys.stdout.write(
            f"{target:15} | {targetDiffs[target][0]:20} | {targetDiffs[target][1]:20} | {targetDiffs[target][2]:20} | {percentage:25}\n"
        )
    sys.stdout.write("\n")
    sys.stdout.write(f"{'='*120}\n")
